  ...
  return (
    ...
    <div className="flex  mx-auto   justify-center items-center h-full ">
        ...
        <div>
          ...
          <form action="#" method="post" className="space-y-4 w-[400px]">
            <div className='mb-5 mt-10'>
              ...
              <input
                id="email"
                className="border p-3 shadow-md placeholder:text-base focus:border-purple-700 focus:scale-105 border-t-0 border-r-0 border-l-0 border-b-2 mb-5  ease-in-out duration-300 border-gray-300 rounded-lg w-full "
                type="email"
            ...
            <button
              className="bg-purple-600 shadow-lg mt-24 p-2 text-white rounded-lg w-full hover:scale-100 hover:bg-purple-700 transition duration-300 ease-in-out"
              type="submit"
            >
              LOG IN
            </button>
          ...
          <div className="flex flex-col mt-10 items-center justify-center text-sm">
            <h3>
              ...
              <a
                className="group text-purple-700 ml-2  font-bold transition-all duration-100 ease-in-out"
                href="/universitysignuppage"
              >
      ...
      <div className='absolute bottom-10 left-36'>
          <img src={Smart} alt=""  className='h-[400px]'/>
      </div>
        <img
          src={UniversityLogin}
