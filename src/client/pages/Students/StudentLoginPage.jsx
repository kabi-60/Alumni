...
const StudentLoginPage = () => {
  return (
    ...
    <div className="flex  mx-auto   justify-center items-center h-full ">
      ...
      >
        <div className="h-[700px] shadow-2xl border-r-0 relative border  flex items-center  rounded-[20px] xl:p-10 2xl:p-16 lg:p-10 md:p-10 sm:p-2 ">
        ...
        <div>
          ...
          <form action="#" method="post" className="space-y-4 w-[400px]">
            ...
            <button
              className="bg-yellow-500 shadow-lg mt-24 p-2 text-white rounded-lg w-full hover:scale-100 hover:bg-yellow-700 transition duration-300 ease-in-out"
              type="submit"
            >
              LOG IN
            </button>
      ...
      <div className='absolute bottom-0 left-48'>
          <img src={vector} alt=""  className='h-[400px]'/>
      </div>
        <img
          src={studentlogin}
